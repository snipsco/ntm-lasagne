...
^^^^^^^
* **Batch size** : 1
* **Architecture** : Single NTM layer + Recurrent output layer

  - *Memory shape* : ``(128, 20)``
  - *Controller* : Recurrent controller
  - *Heads* : 1 Read head + 1 Write head
...
|                      | ``erase``    | ``GlorotUniform()`` | ``Constant(0.)`` | ``hard_sigmoid`` |
+----------------------+--------------+---------------------+------------------+------------------+
| **Recurrent Layer**  | \-           | ``GlorotUniform()`` | ``Constant(0.)`` | ``sigmoid``      |
+----------------------+--------------+---------------------+------------------+------------------+
