...
from ntm.controllers import RecurrentController
from ntm.heads import WriteHead, ReadHead
from ntm.updates import graves_rmsprop

from utils.generators import ReversedCopyTask
...
if __name__ == '__main__':
    ...
    generator = ReversedCopyTask(batch_size=1, max_iter=1000000, size=8, max_length=5, end_marker=True)
